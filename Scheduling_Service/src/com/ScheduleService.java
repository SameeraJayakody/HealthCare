...
public class ScheduleService {
	...
	// search 
	  ...
	  @Path("/docSearch")
	  @Produces(MediaType.TEXT_HTML) 
	  public String Search(@FormParam("DoctorName") String DoctorName,@FormParam("DoctorID") String DoctorID)
	  {
		  return itemObj.docSearch(DoctorName,DoctorID); 
	...
	/*
	 * schedule he = new schedule();
	 * 
	 * 
	 * @GET
	 * 
	 * @Path("/getHospital/{Hospital_id}")
	 * 
	 * @Produces(MediaType.APPLICATION_JSON) public Hospital
	 * getHospital(@PathParam("Hospital_id") String Hospital_id) {
	 * 
	 * return he.getHospital(Hospital_id);
	 * 
	 * }
	 */
